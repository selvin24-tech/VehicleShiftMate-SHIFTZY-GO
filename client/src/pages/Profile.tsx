              ...
              <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 rounded-2xl p-5 relative overflow-hidden">
                ...
                <div className="relative flex items-center gap-3">
                  <div className="relative">
                    <Avatar className="w-16 h-16 border-4 border-white shadow-xl">
                      ...
                      <AvatarFallback className="text-blue-600 text-lg font-bold bg-blue-100">{profile.name.charAt(0)}</AvatarFallback>
                    </Avatar>
                    <button onClick={handlePhotoUpload} className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-orange-500 flex items-center justify-center shadow-md border-2 border-white active:scale-95">
                      <Camera className="w-3 h-3 text-white" />
                    </button>
                  </div>
                  <div className="min-w-0">
                    <h2 className="text-white font-extrabold text-base leading-tight truncate">{profile.name}</h2>
                    <p className="text-blue-200 text-xs">{profile.city}</p>
                ...
                <div className="relative flex flex-wrap gap-1.5 mt-4">
                  {[
                    ...
                    { label: "Licence", verified: profile.dlVerified },
