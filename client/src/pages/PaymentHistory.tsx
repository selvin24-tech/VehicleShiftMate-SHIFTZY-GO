    ...
    <div className="space-y-3">
      {payments.map((p, i) => (
        <motion.div
          ...
          className="bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 rounded-2xl p-4 shadow-sm"
        >
    ...
    return (
      <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
        ...
        <main className="max-w-3xl mx-auto px-6 py-8">
          ...
          <p className="text-sm text-neutral-500 mt-1 mb-5">All your payments and refunds in one place.</p>
